        ...
        synchronized (bubbles) {
            for (Bubble bubble : bubbles) {
                ...
                if (bY - speedY <= -bRadius || bX + speedX <= -bRadius || bX + speedX >= width + bRadius) {
                    ...
                    paint.setShader(new RadialGradient(bX, bY, bRadius, getResources().getColor(R.color.transparent), getResources().getColor(R.color.white_transparent), Shader.TileMode.CLAMP));
