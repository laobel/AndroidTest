 ...
 * 直播推流实例
 */
public class PublishActivity extends AppCompatActivity implements View.OnClickListener, NodePublisherDelegate {
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 2000:
                    Toast.makeText(PublishActivity.this, "正在发布视频", Toast.LENGTH_SHORT).show();
                    break;
                case 2001:
                ...
                case 2002:
                    ...
                    break;
                case 2004:
                    Toast.makeText(PublishActivity.this, "视频发布结束", Toast.LENGTH_SHORT).show();
                    videoBtn.setBackgroundResource(R.drawable.ic_video_stop);
                    isStarting = false;
                    break;
                case 2005:
                    Toast.makeText(PublishActivity.this, "网络异常,发布中断", Toast.LENGTH_SHORT).show();
                    break;
                case 2100:
                    // 发布端网络阻塞，已缓冲了2秒的数据在队列中
                    Toast.makeText(PublishActivity.this, "网络阻塞，发布卡顿", Toast.LENGTH_SHORT).show();
                    break;
                case 2101:
                    // 发布端网络恢复畅通
                    Toast.makeText(PublishActivity.this, "网络恢复，发布流畅", Toast.LENGTH_SHORT).show();
                    break;
                case 2102:
                    Toast.makeText(PublishActivity.this, "截图保存成功", Toast.LENGTH_SHORT).show();
                    break;
                case 2103:
                    Toast.makeText(PublishActivity.this, "截图保存失败", Toast.LENGTH_SHORT).show();
                    break;
                case 2104:
                    Toast.makeText(PublishActivity.this, "网络阻塞严重,无法继续推流,断开连接", Toast.LENGTH_SHORT).show();
                    break;
                case 2300:
                    Toast.makeText(PublishActivity.this, "摄像头和麦克风都不能打开,用户没有给予访问权限或硬件被占用", Toast.LENGTH_SHORT).show();
                    break;
                case 2301:
                    Toast.makeText(PublishActivity.this, "麦克风无法打开", Toast.LENGTH_SHORT).show();
                    break;
                case 2302:
                    Toast.makeText(PublishActivity.this, "摄像头无法打开", Toast.LENGTH_SHORT).show();
                    break;
                case 3100:
                    // mic off
                    micBtn.setBackgroundResource(R.drawable.ic_mic_off);
                    Toast.makeText(PublishActivity.this, "麦克风静音", Toast.LENGTH_SHORT).show();
                    break;
                case 3101:
                    // mic on
                    micBtn.setBackgroundResource(R.drawable.ic_mic_on);
                    Toast.makeText(PublishActivity.this, "麦克风恢复", Toast.LENGTH_SHORT).show();
                    break;
                case 3102:
                    // camera off
                    camBtn.setBackgroundResource(R.drawable.ic_cam_off);
                    Toast.makeText(PublishActivity.this, "摄像头传输关闭", Toast.LENGTH_SHORT).show();
                    break;
                case 3103:
                    // camera on
                    camBtn.setBackgroundResource(R.drawable.ic_cam_on);
                    Toast.makeText(PublishActivity.this, "摄像头传输打开", Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
