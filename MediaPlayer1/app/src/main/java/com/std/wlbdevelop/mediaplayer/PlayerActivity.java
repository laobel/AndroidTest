...
public class PlayerActivity extends AppCompatActivity implements NodePlayerDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        int bufferTime = Integer.valueOf(Options.bufferTime);
         ...
         */
        int maxBufferTime = Integer.valueOf(Options.maxBufferTime);
...
//        np.setRtspTransport(NodePlayer.RTSP_TRANSPORT_TCP);
         ...
         * 设置播放直播视频url
         */
        String playUrl = Options.fetchUrl;
        np.setInputUrl(playUrl);

        Toast.makeText(this,playUrl,Toast.LENGTH_SHORT);
        /**
